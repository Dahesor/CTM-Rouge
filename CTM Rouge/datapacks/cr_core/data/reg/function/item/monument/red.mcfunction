data modify storage reg:item new set value {\
    ...
    stack:{\
        ...
        components:{\
        max_stack_size:1,\
        custom_data:{item:{class:"wool",id:"red_wool"}},\
        ...
        damage_resistant:{types:"#rcore:all"},"minecraft:tooltip_style":"crouge:wool/red",\
        item_model:"crouge:wools/red"\
        }\
    }\
}

scoreboard players set wool.red.score const 200
