data modify storage reg:item new set value {\
    ...
    stack:{\
        ...
        components:{\
        max_stack_size:1,\
        custom_data:{item:{class:"wool",id:"light_gray_wool"}},\
        ...
        damage_resistant:{types:"#rcore:all"},"minecraft:tooltip_style":"crouge:wool/light_gray",\
        item_model:"crouge:wools/light_gray"\
        }\
    }\
}

scoreboard players set wool.light_gray.score const 200
