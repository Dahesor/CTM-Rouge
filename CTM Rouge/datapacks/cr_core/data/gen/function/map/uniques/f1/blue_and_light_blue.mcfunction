...
execute if score #rand calculator.cr matches ..50 run data modify storage ram: map_cell merge value {type:"special",special:"light_blue_wool"}
execute unless score #rand calculator.cr matches ..50 run data modify storage ram: map_cell merge value {type:"special",special:"blue_wool"}
