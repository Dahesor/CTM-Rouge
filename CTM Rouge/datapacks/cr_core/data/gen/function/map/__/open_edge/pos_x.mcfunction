...
data modify storage ram: map_cell.connections.pos_x set value true
...
data modify storage run: i.dir set value "neg_x"
...
execute store result storage ram: disjoint.input_2 int 1 run scoreboard players add $this calculator.cr 1
