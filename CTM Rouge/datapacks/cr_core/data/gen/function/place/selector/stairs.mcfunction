...
execute if data storage ram: map_cell.stair_room{1_0_one_way:true} run return run data modify storage ram: struct_res.res set value "path:stairs/2_1_accelerator"
