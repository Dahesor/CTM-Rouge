...
execute store result score #index calculator.cr run data get storage ram: disjoint.input_1
...
execute store result score #index calculator.cr run data get storage ram: disjoint.input_2
scoreboard players operation #x calculator.cr = #index calculator.cr
...
execute if score #count calculator.cr matches 1.. run function gen:disjoint/base/it