...
setblock ~ ~-1 ~ structure_block[mode=save]{author:"?",integrity:1.0f,mirror:"NONE",mode:"SAVE",ignoreEntities:false,posX:1,posY:1,posZ:1,showboundingbox:true,showair:false,sizeX:32,sizeY:36,sizeZ:32,rotation:"NONE",name:"corner:"}
