...
execute store result score #temp calculator.cr run clear @s *[custom_data~{soul_bind:{name:"hpkit"}}] 0
execute unless score #temp calculator.cr matches 1 run function rcore:player/utils/soul_bind/hpkit
