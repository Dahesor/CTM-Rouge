...
execute if score @s input matches 1.. run function rcore:menu/trigger/input
...
execute if score #loop_5 calculator.cr matches 1 if entity @s[gamemode=spectator,scores={revive_cd=1..}] run function rcore:menu/map/specialize
