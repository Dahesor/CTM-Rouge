data modify storage core:player itemStack set from storage core:player data[0].backpack.equipment.chest
...
item replace entity @s armor.chest from entity 0-0-0-0-0 container.0