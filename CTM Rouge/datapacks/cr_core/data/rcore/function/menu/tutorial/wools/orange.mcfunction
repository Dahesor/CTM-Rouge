...
data modify storage ram: dialog.dialog.body[2].contents[4] set from storage ram: item.components."minecraft:lore"[-1]
data modify storage ram: dialog.dialog.body[2].contents[2] set from storage ram: item.components."minecraft:lore"[-2]
data modify storage ram: dialog.dialog.body[2].contents[0] set from storage ram: item.components."minecraft:lore"[-3]
