execute if entity @e[type=slime,tag=boss.slime_king,distance=..4] run return run function rcore:ai/slime/collide/glue

execute summon marker run function rcore:math/track_item/motion
