execute if score $this floor matches 0 store result score #rarity calculator.cr run function rcore:core/spawner/rates/0
execute if score $this floor matches 1 store result score #rarity calculator.cr run function rcore:core/spawner/rates/1
execute if score $this floor matches 2 store result score #rarity calculator.cr run function rcore:core/spawner/rates/2
